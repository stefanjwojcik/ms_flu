...
\end{table}
 ...
 \textbf{\underline{National Tracking Model Performance Metrics}}\par\medskip
    \includegraphics[width=.45\linewidth]{USBox_h=1}\\
        \subfloat[\label{boxp} Absolute Error boxplot.]{\hspace{.3\linewidth}}\\
...
\bibliography{main_flu_citations}
